    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          >
            <BlurView intensity={30} tint="dark" style={styles.toggleGlass}>
              <View style={styles.toggleInfo}>
                <View style={styles.iconContainer}>
                  <Ionicons name="briefcase" size={24} color={isBusinessMode ? '#4BE277' : '#FFFFFF'} />
                </View>
            ...
            >
              ...
              <View style={styles.form}>
                <Input
                  ...
                  leftIcon={<Ionicons name="business-outline" size={20} color="rgba(255,255,255,0.5)" />}
                />
                ...
                <Input
                  ...
                  leftIcon={<Ionicons name="document-text-outline" size={20} color="rgba(255,255,255,0.5)" />}
                />
              ...
              <View style={styles.infoBox}>
                <Ionicons name="information-circle" size={20} color="#4BE277" />
