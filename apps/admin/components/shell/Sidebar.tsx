...
export function Sidebar({ role, badges }: { role: Role; badges?: Record<string, number> }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-[70] flex flex-col bg-surface border-r border-line transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        >
          <span className="w-6 h-6 rounded-md bg-accent text-[color:var(--on-accent)] grid place-items-center font-bold text-[13px] flex-none">
            E
          </span>
