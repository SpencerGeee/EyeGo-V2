...
const makeStyles = (colors: DriverColors) =>
  StyleSheet.create({
    ...
    sosBtnText: { fontFamily: fonts.displayBold, fontSize: 14, color: '#fff', letterSpacing: 0.5 },
    card: {
    ...
    cardTitle: { fontFamily: fonts.displaySemiBold, fontSize: fontSizes.titleSmall, color: colors.onSurface },
    editBtn: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    editBtnText: { fontFamily: fonts.semiBold, fontSize: fontSizes.bodySmall ?? 12, color: colors.primary },
    ...
    contactInitial: { fontFamily: fonts.displayBold, fontSize: 18, color: colors.primary },
    contactName: { fontFamily: fonts.semiBold, fontSize: fontSizes.bodyMedium, color: colors.onSurface },
    callBtn: {
      width: 36,
      height: 36,
      borderRadius: 18,
