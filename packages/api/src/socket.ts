...
const driverCallbacks = new Map<Function, Function>();
...
export const socketEvents = {
  ...
  onTripStatus: (cb: (data: TripStatusEvent) => void) => {
    // Both trip:status and trip:status_change might be emitted
  ...
  onChatMessage: (cb: (msg: { senderId: string; text: string; timestamp: string; senderName?: string }) => void) => {
...
export const driverSocketEvents = {
  ...
  onChatMessage: (cb: (msg: { senderId: string; senderName?: string; text: string; timestamp: string }) => void) => {
